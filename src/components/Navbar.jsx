...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[50px] flex justify-center items-center px-4 text-[var(--color1)] bg-[var(--color4)] shadow-md  dark:bg-[#11294e] dark:text-orange-200 minsm:bottom-0 z-50">
      {/*//! Menu */}
